      ...
      <div class="mad-breadcrumb simple-type">
        <div class="container wide">
          <nav class="mad-breadcrumb-path">
            <span><a href="index.php" class="mad-link">Home</a> / <span>Aurora’s Story</span>
          </nav>
        </div>
      </div>
      <!--================ End of Breadcrumb ================-->
      <div class="mad-content">
        <div class="container">
          <div class="content-element-main">
            <h1 class="align-center">Aurora’s Story</h1>
            <div class="row sticky-bar">
              <main id="main" class="col-xl-8">
                <div class="content-element-4">
                  <div class="mad-img"><img src="images/Baby-born-at-Maternity-Africa-Kivulini-centre.jpg" alt=""></div>
                </div>
                <div class="content-element-4">
                  <div class="mad-img"><img src="images/gettyimages-487318733_custom-e2f70e64686d892d7b1069f799a8522bfb16350e-s1200.jpg" alt=""></div>
                </div>
                <div class="content-element-4">
                  <div class="mad-img"><img src="images/entity_bg8.jpg" alt=""></div>
                </div>
              </main>
              <aside id="sidebar" class="col-xl-4 mad-sidebar">
                <div class="content-element-4">
                  <h4 class="mad-title">Description</h4>
                  <p class="mad-text-medium content-element-4"> In Aurora's story, she takes us on a journey of safe child delivery, highlighting the crucial role played by Olubaresi Charity Foundation (OCF) in ensuring the well-being of mothers and newborns in communities like Aurora's. OCF's initiatives have made childbirth a safer and more joyous experience, demonstrating the positive impact of the foundation's work.</p>
            ...
            <ul class="mad-pagination">
              <li>
                <a href="portfolio_single_img_side_Sarah.php" class="prev mad-arrows"><span class="material-icons">
              ...
              <li>
                <a href="portfolio_single_img_side_Faraji.php" class="next mad-arrows"><span class="material-icons">
