      ...
      <div class="mad-breadcrumb simple-type">
        <div class="container wide">
          <nav class="mad-breadcrumb-path">
            <span><a href="index.php" class="mad-link">Home</a></span> / <a href="pages_what_we_do.php"
              class="mad-link">What we do</a></span> / <span>Medicine</span>
          </nav>
        </div>
      </div>
      <!--================ End of Breadcrumb ================-->
      <div class="mad-content">
        <div class="container">
          <div class="content-element-4">
            <h1 class="align-center">Medicine</h1>
            <div class="content-element-4">
              <div class="mad-img"><img src="images/okaaaa.jpg" alt="" /></div>
            </div>
            <div class="content-element-4">
              <div class="mad-img"><img src="images/IMG_0904.jpgAPHRC-768x512.jpg" alt="" /></div>
            </div>
            <div class="content-element-4">
              <div class="mad-img"><img src="images/gettyimages-487318733_custom-e2f70e64686d892d7b1069f799a8522bfb16350e-s1200.jpg" alt="" /></div>
            </div>
          </div>
          <div class="content-element-main">
            <div class="row hr-size-1">
              <div class="col-xl-8">
                <h4 class="mad-title">Medicine</h4>
                <p class="content-element-4"> In our commitment to healthcare and access to medicine, Olubaresi Charity Foundation strives to provide essential medical assistance to those in need. We believe that quality healthcare is a basic human right, and it is our goal to make a difference in the lives of individuals facing health challenges. Through partnerships with medical facilities, donations of medical supplies, and healthcare awareness campaigns, we work to address the disparities in healthcare access and promote overall well-being. Your support matters greatly in ensuring that everyone has access to necessary medical care and resources. By donating to Olubaresi Charity Foundation, you actively contribute to our mission to enhance the quality of healthcare and save lives in our communities.</p>
              ...
              <div class="col-xl-4">
                <div class="mad-rest-info size-2">
                  ...
                  <div class="mad-rest-info-item">
                    ...
                    <span><a href="portfolio_grid_3_cols.html" class="mad-link">Mokolo Raymond</a></span>
                  </div>
                  <div class="mad-rest-info-item">
            ...
            <ul class="mad-pagination">
              <li>
                <a href="portfolio_single_img_food.php" class="prev mad-arrows"><span class="material-icons">
                    arrow_back_ios </span><span>Previous</span></a>
              </li>
              <li>
                <a href="portfolio_standart_2_cols.php"><img src="charity_icons_svg/grid.svg" class="svg" alt="" /></a>
              </li>
              <li>
                <a href="portfolio_single_img_education.php" class="next mad-arrows"><span class="material-icons">
                    arrow_forward_ios </span><span>Next</span></a>
              </li>
            </ul>
          </div>
          <h2 class="mad-title align-center">Related Portfolio Posts</h2>
          <?php include 'portfolio_posts.php'; ?>
