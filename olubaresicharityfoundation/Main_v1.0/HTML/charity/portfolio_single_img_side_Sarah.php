      ...
      <div class="mad-breadcrumb simple-type">
        <div class="container wide">
          <nav class="mad-breadcrumb-path">
            <span><a href="index.php" class="mad-link">Home</a></span>  / <span>Sarah’s Story</span>
          </nav>
        </div>
      </div>
      <!--================ End of Breadcrumb ================-->
      <div class="mad-content">
        <div class="container">
          <div class="content-element-main">
            <h1 class="align-center">Sarah’s Story</h1>
            <div class="row sticky-bar">
              <main id="main" class="col-xl-8">
                <div class="content-element-4">
                  <div class="mad-img"><img src="images/entity_bg7.jpg" alt=""></div>
                </div>
                <div class="content-element-4">
                  <div class="mad-img"><img src="images/R (6).jpg" alt=""></div>
                </div>
                <div class="content-element-4">
                  <div class="mad-img"><img src="images/R (13).jpg" alt=""></div>
                </div>
              </main>
              <aside id="sidebar" class="col-xl-4 mad-sidebar">
                <div class="content-element-4">
                  <h4 class="mad-title">Description</h4>
                  <p class="mad-text-medium content-element-4">In a rural Nigerian village, a young girl named Sarah faced daily hardships fetching contaminated water from a distant stream. Olubaresi Charity Foundation (OCF) intervened, providing the village with clean water through a well-equipped project. This transformative effort improved Sarah's life and the entire community's well-being, highlighting OCF's vital work.</p>
            ...
            <ul class="mad-pagination">
              <li>
                <a href="portfolio_single_img_side_Daniel.php" class="prev mad-arrows"><span class="material-icons">
              ...
              <li>
                <a href="portfolio_single_img_side_aurora.php" class="next mad-arrows"><span class="material-icons">
