      ...
      <div class="mad-breadcrumb simple-type">
        <div class="container wide">
          <nav class="mad-breadcrumb-path">
            <span><a href="index.php" class="mad-link">Home</a> / <span>Amina’s Story</span>
          </nav>
        </div>
      </div>
      <!--================ End of Breadcrumb ================-->
      <div class="mad-content">
        <div class="container">
          <div class="content-element-main">
            <h1 class="align-center">Amina's Inspirational Journey</h1>
            <div class="row sticky-bar">
              <main id="main" class="col-xl-8">
                <div class="content-element-4">
                  <div class="mad-img"><img src="images/entity_bg5.jpg" alt=""></div>
                </div>
                <div class="content-element-4">
                  <div class="mad-img"><img src="images/4105732196_7e8d4bbc90_o-768x508.jpg" alt=""></div>
                </div>
                <div class="content-element-4">
                  <div class="mad-img"><img src="images/8154389315_40957e2b72.jpg" alt=""></div>
                </div>
              </main>
              <aside id="sidebar" class="col-xl-4 mad-sidebar">
                <div class="content-element-4">
                  <h4 class="mad-title">Description</h4>
                  <p class="mad-text-medium content-element-4"> Amina's Story reflects Olubaresi Charity Foundation's mission of empowering individuals and communities. Despite facing challenges, Amina's determination, combined with the Foundation's support, led to a brighter future. Through educational and healthcare initiatives, the Foundation provided essential assistance, illustrating its commitment to holistic community development. Amina's success exemplifies how Olubaresi Charity Foundation transforms lives, offering hope, resilience, and opportunities for those in need.</p>
            ...
            <ul class="mad-pagination">
              <li>
                <a href="portfolio_single_img_side_aurora.php" class="prev mad-arrows"><span class="material-icons">
              ...
              <li>
                <a href="portfolio_single_img_side_Daniel.php" class="next mad-arrows"><span class="material-icons">
