        ...
        <div class="container wide">
          <nav class="mad-breadcrumb-path">
            <span><a href="index.php" class="mad-link">Home</a></span> / <a href="pages_what_we_do.php"
              class="mad-link">What we do</a></span> / <span>Food</span>
          </nav>
        </div>
      </div>
      <!--================ End of Breadcrumb ================-->
      <div class="mad-content">
        <div class="container">
          <div class="content-element-4">
            <h1 class="align-center">Food</h1>
            <div class="content-element-4">
              <div class="mad-img"><img src="images/R (19).jpg" alt="" /></div>
            </div>
            <div class="content-element-4">
              <div class="mad-img"><img src="images/27aa0b98d38e.jpg" alt="" /></div>
            </div>
            <div class="content-element-4">
              <div class="mad-img"><img src="images/R (14).jpg" alt="" /></div>
            </div>
          </div>
          <div class="content-element-main">
            <div class="row hr-size-1">
              <div class="col-xl-8">
                <h4 class="mad-title">Food</h4>
                <p class="content-element-4"> In the realm of food assistance, our efforts at Olubaresi Charity Foundation are grounded in the belief that access to nourishment is a fundamental human right. We are dedicated to addressing issues of hunger and food insecurity in our communities. Our approach encompasses various initiatives such as food distribution programs, partnerships with local food banks, and campaigns to raise awareness about the importance of combating hunger. By donating to Olubaresi Charity Foundation, you become an essential part of our mission to alleviate hunger and ensure that everyone has access to the nourishment they need for a healthy and fulfilling life. Your contribution will make a meaningful impact in the fight against hunger. </p>
            ...
            <ul class="mad-pagination">
              <li>
                <a href="portfolio_single_img_education.php" class="prev mad-arrows"><span class="material-icons">
              ...
              <li>
                <a href="portfolio_single_img_medicine.php" class="next mad-arrows"><span class="material-icons">
