      ...
      <div class="mad-breadcrumb simple-type">
        <div class="container wide">
          <nav class="mad-breadcrumb-path">
            <span><a href="index.php" class="mad-link">Home</a></span> / <a href="pages_about.php"
              class="mad-link">About Us</a> / <span>Our Drive</span>
          </nav>
        </div>
      </div>
      <!--================ End of Breadcrumb ================-->
      <div class="mad-content">
        <div class="container">
          <div class="content-element-4">
            <h1 class="align-center">Our Drive</h1>
            <div class="owl-carousel mad-img mad-grid mad-simple-slideshow no-dots ">
              <div class="mad-img">
          ...
          <div class="content-element-main">
            <div class="row hr-size-1">
              <div class="col-xl-8">
                <h4 class="mad-title">Our Drive</h4>
                <p class="mad-text-medium content-element-4">At Olubaresi Charity Foundation (OCF), our unwavering commitment to service fuels our drive to make a positive impact in the world. We are dedicated to generating the necessary resources to fulfill our noble objectives. Our primary sources of funding are derived from a combination of grants, generous donations from individuals and corporate bodies, and membership dues and contributions.
<br>
Our ultimate drive goes beyond just securing financial support; it's about putting these resources and activities to meaningful use. We strive to channel our efforts and resources into initiatives that bring smiles to people's faces. Whether it's through educational programs, healthcare support, clean water access, or any of our various projects, we are driven by the desire to make a tangible difference in the lives of those we serve.
<br>

At OCF, our commitment to service is the cornerstone of everything we do. We are passionate about transforming lives, and our dedication to this cause is unwavering. With the support of our generous donors and partners, we look forward to achieving even more in the service of humanity.</p>
            ...
            <ul class="mad-pagination">
              <li>
                <a href="portfolio_single_slider_aim.php" class="prev mad-arrows"><span class="material-icons">
                    arrow_back_ios </span><span>Previous</span></a>
              </li>
              <li>
                <a href="portfolio_grid_3_cols.php"><img src="charity_icons_svg/grid.svg" class="svg" alt="" /></a>
              </li>
              <li>
                <a href="portfolio_single_slider_dream.php" class="next mad-arrows"><span class="material-icons">
          ...
          <div class="mad-portfolio item-col-3">
              ...
              <div class="mad-gallery-item">
                ...
                <div class="mad-gallery-desc">
                  ...
                  <h4 class="mad-gallery-name">
                    <a href="portfolio_grid_3_cols.html">Mauris Fermentum</a>
                  </h4>
                </div>
              </div>
            </div>
            <div class="mad-col">
              <div class="mad-gallery-item">
                <a href="portfolio_single_grid.html" class="mad-gallery-media"><img src="images/475x368_img10.jpg"
                    alt="" /></a>
                <div class="mad-gallery-desc">
                  <a href="portfolio_grid_3_cols.html" class="mad-gallery-cat">Volunteering</a>
                  <h4 class="mad-gallery-name">
                    <a href="portfolio_grid_3_cols.html">Vestibulum Libero</a>
                  </h4>
                </div>
              </div>
            </div>
            <div class="mad-col">
              <div class="mad-gallery-item">
                <a href="portfolio_single_grid.html" class="mad-gallery-media"><img src="images/475x368_img11.jpg"
                    alt="" /></a>
                <div class="mad-gallery-desc">
                  <a href="portfolio_grid_3_cols.html" class="mad-gallery-cat">Donation</a>
                  <h4 class="mad-gallery-name">
                    <a href="portfolio_grid_3_cols.html">Nam Elit Agna</a>
                  </h4>
                </div>
              </div>
            </div>
