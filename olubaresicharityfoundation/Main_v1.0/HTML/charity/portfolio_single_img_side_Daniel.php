      ...
      <div class="mad-breadcrumb simple-type">
        <div class="container wide">
          <nav class="mad-breadcrumb-path">
            <span><a href="index.php" class="mad-link">Home</a> / <span>Daniel’s Story</span>
          </nav>
        </div>
      </div>
      <!--================ End of Breadcrumb ================-->
      <div class="mad-content">
        <div class="container">
          <div class="content-element-main">
            <h1 class="align-center">Daniel’s Story</h1>
            <div class="row sticky-bar">
              <main id="main" class="col-xl-8">
                <div class="content-element-4">
                  <div class="mad-img"><img src="images/entity_bg6.jpg" alt=""></div>
                </div>
                <div class="content-element-4">
                  <div class="mad-img"><img src="images/R (12).jpg" alt=""></div>
                </div>
                <div class="content-element-4">
                  <div class="mad-img"><img src="images/a6182041305b818d8a734ae0750fe9e3.jpg" alt=""></div>
                </div>
              </main>
              <aside id="sidebar" class="col-xl-4 mad-sidebar">
                <div class="content-element-4">
                  <h4 class="mad-title">Description</h4>
                  <p class="mad-text-medium content-element-4"> Daniel's journey is a testament to the transformative power of our foundation's work. Despite facing immense adversity, his unwavering determination to pursue education is truly inspiring. He has overcome countless obstacles to access quality education and has emerged as a shining example of resilience and hope. The Olubaresi Charity Foundation has been a crucial part of his journey, providing support and opportunities that have helped Daniel achieve his dreams. His story serves as a compelling reminder of the positive impact we can make by empowering individuals to overcome challenges and create a brighter future through education. Daniel's success reflects the potential within all those we strive to assist and empower</p>
            ...
            <ul class="mad-pagination">
              <li>
                <a href="portfolio_single_img_side_Faraji.php" class="prev mad-arrows"><span class="material-icons">
              ...
              <li>
                <a href="portfolio_single_img_side_Sarah.php" class="next mad-arrows"><span class="material-icons">
